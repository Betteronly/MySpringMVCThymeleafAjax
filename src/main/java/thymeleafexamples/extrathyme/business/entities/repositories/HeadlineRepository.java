...
public class HeadlineRepository {
    ...
    public List<Headline> findAllHeadlines() {
        ...
        headlines.add(new Headline(Calendar.getInstance(),
                "Spearmint Caterpillars 1 - 0 Parsley Warriors"));
        headlines.add(new Headline(Calendar.getInstance(),
                "Laurel Troglodytes 1 - 1 Rosemary 75ers"));
        headlines.add(new Headline(Calendar.getInstance(),
                "Saffron Hunters 0 - 2 Polar Corianders"));
        headlines.add(new Headline(Calendar.getInstance(),
                "Angry Red Peppers 4 - 2 Basil Dragons"));
        headlines.add(new Headline(Calendar.getInstance(),
