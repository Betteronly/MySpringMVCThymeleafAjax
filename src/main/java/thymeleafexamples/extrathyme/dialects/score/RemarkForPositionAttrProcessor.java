...
public class RemarkForPositionAttrProcessor extends
    ...
    protected String getText(final Arguments arguments, final Element element,
         ...
         */
        final Integer position = (Integer) expression.execute(configuration,
                arguments);
         ...
         */
        return getMessage(arguments, "remarks." + remark.toString(),
                new Object[0]);
