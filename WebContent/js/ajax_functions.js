...
function theHTTPResponse() {
  if (myReq.readyState == 4) {
    if (myReq.status == 200) {
      ...
      //      document.getElementById('showtime').innerHTML = 'It is 12:56:59 on Aug 04, 2008.';
    ...
    document.getElementById('showtime').innerHTML = '<img src="/thymeleaf_springmvc_demo_01/images/extrathymelogo.png" width="280px" height="50px"/>';
  }
}